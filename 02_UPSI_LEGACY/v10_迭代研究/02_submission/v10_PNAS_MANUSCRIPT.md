...
1. Mesopotamian validation corrected: v9.0 incorrectly reported 7/8 (87.5%) based on v7 CDLI data; v10.0 reports actual v9a ORACC multi-period result 6/8 (75.0%)
...
3. Abstract/Significance updated: recall threshold >82% → >75%; Mesopotamian 75.0% honestly reported with proxy limitations
4. Results ¶3 expanded: Added explicit discussion of Umma and Hammurabi failures, SFD proxy limitations, and data-sparse periods
5. Discussion limitations expanded: Added ORACC proxy failure analysis and data-sparse period caveats
6. Methods expanded: Added SFD proxy formula and adaptive window specification
