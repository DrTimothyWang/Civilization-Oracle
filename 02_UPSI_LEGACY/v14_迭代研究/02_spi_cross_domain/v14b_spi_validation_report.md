# v14b SPI Cross-Domain Validation Report
...
- **Records**: 35794 biographies over 30 windows
- **Confidence**: EXACT
- **Max SPI**: 2.815 at window starting 620

**Crisis Alignment**:
- **An Lushan Rebellion** (755): SPI=0.145, Alert=NORMAL → ❌ MISSED

**Alert Windows**:
- 620 to 629: SPI=2.815 (CRITICAL)
- 630 to 639: SPI=1.688 (ELEVATED)
...
- **Records**: 18877 biographies over 11 windows
- **Confidence**: EXACT
- **Max SPI**: 1.972 at window starting 1030

**Crisis Alignment**:
- **Jingkang Catastrophe** (1127): SPI=0.118, Alert=NORMAL → ❌ MISSED

**Alert Windows**:
- 1030 to 1039: SPI=1.972 (ELEVATED)
...
- **Records**: 22636 biographies over 16 windows
- **Confidence**: EXACT
- **Max SPI**: 1.752 at window starting 1130

**Crisis Alignment**:
- **Jingkang Catastrophe aftermath** (1128): SPI=-0.524, Alert=NORMAL → ❌ MISSED
- **Mongol invasion intensifies** (1234): SPI=-0.038, Alert=NORMAL → ❌ MISSED

**Alert Windows**:
- 1130 to 1139: SPI=1.752 (ELEVATED)
...
- **Average resolution**: 70.35714285714286 years per point
...
**Results**:
- **Crisis of the Third Century** (235): SPI=0.297, Alert=NORMAL → ❌ MISSED
- **Fall of Western Empire** (476): SPI=0.188, Alert=NORMAL → ❌ MISSED
...
- **Records**: 103 daily bars
- **Confidence**: EXACT
- **Max SPI**: 2.42

**Crisis Alignment**:
- **COVID Crash** (2020-03-16): SPI=1.13, Alert=NORMAL → ❌ MISSED

**Alert Windows**:
- 2020-03-06 to 2020-03-10: SPI=1.593 (ELEVATED)
- 2020-03-26 to 2020-03-30: SPI=2.42 (ELEVATED)
...
**Crisis Alignment**:
- **Russia-Ukraine Shock** (2022-02-24): SPI=0.512, Alert=NORMAL → ❌ MISSED

**Alert Windows**:
- No elevated or critical alerts detected.
...
- **Records**: 41 daily bars
- **Confidence**: EXACT
- **Max SPI**: 1.389

**Crisis Alignment**:
- **Snowball Crash (VIX spike)** (2024-01-17): SPI=1.222, Alert=NORMAL → ❌ MISSED
