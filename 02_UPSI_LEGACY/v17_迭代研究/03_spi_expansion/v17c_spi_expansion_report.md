...
|--------|-----------|--------------|---------------------|----------|-------------|
| Global Politics | INTERPOLATED | ✅ Yes | 18 | 6/18 | Sparse (0.16 events/year) |
...
| COVID-19 (23 countries) | EXACT | ✅ Yes | ~21 | 6/~21 | High (daily OWID) |
...
- **Alert windows**: 47 ELEVATED, 19 CRITICAL
...
**Total alerts across 23 countries**: 265
**Total waves tested**: ~21 (3 waves × 7 countries with known wave dates)
**Waves captured**: 6/~21 = 29% if >0 else N/A
